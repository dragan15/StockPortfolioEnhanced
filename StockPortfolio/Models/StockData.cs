...
namespace StockPortfolio.Models
{
    ...
    public partial class StockData
    {
        public static StockData FromJson(string json) => JsonConvert.DeserializeObject<StockData>(json, StockPortfolio.Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this StockData self) => JsonConvert.SerializeObject(self, StockPortfolio.Models.Converter.Settings);
    }
